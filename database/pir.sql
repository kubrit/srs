...
--
-- Host: localhost
-- Czas generowania: 10 Gru 2017, 18:37
...
--
-- Struktura tabeli dla tabeli `conversations_members`
--
...
--
-- Struktura tabeli dla tabeli `conversations_messages`
--
...
--
-- Struktura tabeli dla tabeli `shipments_types`
--
...
--
-- Zrzut danych tabeli `shipments_types`
--
...
--
-- Indexes for table `shipments_types`
--
...
--
-- AUTO_INCREMENT dla tabeli `conversations_members`
--
ALTER TABLE `conversations_members`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT dla tabeli `conversations_messages`
--
ALTER TABLE `conversations_messages`
...
--
-- AUTO_INCREMENT dla tabeli `shipments_types`
--
ALTER TABLE `shipments_types`
